...
class StatusSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $statues = [
            ...
            ['name' => 'Partner/Managing Partner', 'status' => 'Relationship'],
            ['name' => 'Male', 'status' => 'Gender'],
            ['name' => 'Female', 'status' => 'Gender'],
            ['name' => 'Joint-stock Company', 'status' => 'Gender'],
            ...
            ['name' => 'Government Job', 'status' => 'Occupation Title'],
            ['name' => 'Semi Government Job', 'status' => 'Occupation Title'],
            ['name' => 'Autonomous Body Job', 'status' => 'Occupation Title'],
            ...
            ['name' => 'Others', 'status' => 'Occupation Title'],
