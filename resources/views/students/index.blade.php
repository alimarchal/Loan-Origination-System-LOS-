...
{{--        <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700;400italic;700italic&display=swap" rel="stylesheet">--}}
        ...
        <form method="GET" action="{{ route('students.index') }}">
            <div class="mt-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="filter[gender]" id="gender"
                ...
                <div>
                    ...
                    <select name="filter[qualification]" id="qualification"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        <option value="">Select a qualification</option>
                        <option value="Secondary School Certificate / Matriculation / O - level" {{ request('filter.qualification') === 'Secondary School Certificate / Matriculation / O - level' ? 'selected' : '' }}>Secondary School Certificate / Matriculation
                            / O - level
                        </option>
                        <option value="Higher Secondary School Certificate / Intermediate/ A - level" {{ request('filter.qualification') === 'Higher Secondary School Certificate / Intermediate/ A - level' ? 'selected' : '' }}>Higher Secondary School
                            Certificate / Intermediate/ A - level
                        </option>
                ...
                <div>
                    ...
                    <select name="filter[district]" id="district"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                ...
                <div>
                    ...
                    <select name="filter[certification_required]" id="certification_required"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        <option value="">Select a certification</option>
                        @foreach(\App\Models\Category::where('category_type','Certification Required')->get() as $cat)
                            <option value="{{ $cat->id }}" {{ request('filter.certification_required') ==  $cat->id ? 'selected' : '' }} >{{ $cat->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="filter[admission_type]" id="admission_type"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        <option value="">Select a admission type</option>
                        @foreach(\App\Models\Category::where('category_type','Admission Type')->get() as $cat)
                            <option value="{{ $cat->id }}" {{ request('filter.admission_type') ==  $cat->id ? 'selected' : '' }} >{{ $cat->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="filter[computer_knowledge]" id="computer_knowledge"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        ...
                        @foreach(\App\Models\Category::where('category_type','Computer Knowledge')->get() as $cat)
                            <option value="{{ $cat->id }}" {{ request('filter.computer_knowledge') ==  $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="filter[phone_network_id]" id="phone_network_id"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        <option value="">Select a phone network {{ request('filter.phone_network_id') }}</option>
                        <!-- Add your options here -->
                        @foreach(\App\Models\PhoneNetwork::all() as $mn)
                            <option value="{{ $mn->id }}" {{ request('filter.phone_network_id') ==  $mn->id ? 'selected' : '' }} >{{ $mn->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="filter[session_year_id]" id="session_year_id"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        <option value="">Select session year</option>
                        @foreach(\App\Models\SessionYear::all() as $st)
                            <option value="{{ $st->id }}" {{ request('filter.session_year_id') ==  $st->id ? 'selected' : '' }} >{{ \Carbon\Carbon::parse($st->start_year)->format('Y-') . \Carbon\Carbon::parse($st->end_year)->format('Y') }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="filter[blood_group_id]" id="blood_group_id"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        <option value="">Select a blood group</option>
                        @foreach (\App\Models\BloodGroup::all() as $bg)
                            <option value="{{ $bg->id }}" {{ request('filter.blood_group_id') ==  $bg->id ? 'selected' : '' }} >
                                {{ $bg->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="filter[latestStatus.status_id]" id="status"
                            class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                        <option value="">Select a student status</option>
                        @foreach (\App\Models\Status::all() as $st)
                            <option value="{{ $st->id }}" @if(!empty(request('filter')['latestStatus.status_id']))
                                {{ request("filter")['latestStatus.status_id'] == $st->id ? 'selected' : '' }}
                                @endif >
                                {{ $st->name }}
                            </option>
                        @endforeach
                ...
                <div>
                    ...
                    <div>
                        ...
                        <select name="filter[age_between]" id="age_between"
                                class="select2 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
...
{{--                                        /{{ \Carbon\Carbon::parse($student->sessionYear->session->start_year)->format('y-') . \Carbon\Carbon::parse($student->sessionYear->session->end_year)->format('y') }}--}}
                                    </td>

                                    <td class="py-1 px-2 text-center">
                                        <a href="{{ route('admission.edit',$student->id) }}" class="text-blue-600 hover:underline font-extrabold">
                                            {{ $student->gender == 'Male' ? 'Mr.' : 'Ms.' }} {{ $student->firstname . ' ' . $student->lastname }}
                                        </a>

                                    </td>

                                    <td class="py-1 px-2 text-center">
                                        {{ \Carbon\Carbon::parse($student->dob)->diff(\Carbon\Carbon::now())->format('%yy') }}/{{ $student->gender == 'Male' ? 'M' : 'F' }}
                                    </td>
                                    ...
                                    <td class="py-1 px-2 text-center">
                                        ...
                                        @foreach($student->applied_for_certificates as $cert)
                                            <span class="bg-red-100 text-black text-xs me-2 px-2.5 py-0.5 rounded">{{ $cert->certificate->name }}</span>

                                            @if($student->applied_for_certificates->count() > 1 && !$loop->last)
                                                <br>
                                            @endif
                                    ...
                                    <td class="py-1 px-2 text-center ">
                                        {{ $student->latestStatus->status->name }}
                                    </td>

                                    <td class="py-1 px-2 text-center">

                                        {{--                                    <a href="{{ route('admission.edit', $student->id) }}"--}}
                                        {{--                                       class="inline-flex items-center px-0.5 py-0.5 bg-red-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 focus:bg-red-700 active:bg-red-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">--}}
...
{{--                                        <a href="{{ route('student.profile-print', $student->id) }}"--}}
...
{{--                                        </a>--}}
                                                                            ...
                                                                            <a href="{{ route('admission.fee-schedule', $student->id) }}"
                                                                               class="inline-flex items-center px-0.5 py-0.5 bg-green-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                            ...
                                                                            <a href="{{ route('student.profile-print', $student->id) }}"
                                                                               class="inline-flex items-center px-0.5 py-0.5 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                                                    <path stroke-linecap="round" stroke-linejoin="round"
