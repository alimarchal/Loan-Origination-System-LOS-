    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('sanction-advice.store', $borrower->id) }}" enctype="multipart/form-data" id="sanction-form">
                    @csrf
                        ...
                        <div class="px-6 mb-4 lg:px-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent dark:border-gray-700">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-input id="type_of_finance" class="block shadow-none w-full h-8 rounded-none" type="text" name="type_of_finance" value="{{ $borrower->loan_category->name }} - {{ $borrower->loan_sub_category->name }}" readonly />
                                    </td>
                                    <td class="font-bold">SGL Code:</td>
                                    <td>
                                        <x-input id="sgl_code" class="block shadow-none w-full h-8 rounded-none" type="text" name="sgl_code" value="4160"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <x-input id="purpose_of_finance" class="block shadow-none w-full h-8 rounded-none" type="text" name="purpose_of_finance" value="{{ $borrower->applicant_requested_loan_information->loan_purpose ?? 'N/A' }}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-bold">Tenure:</td>
                                    <td>
                                        <x-input id="tenure" class="block shadow-none w-full h-8 rounded-none" type="text" name="tenure" :value="$borrower->applicant_requested_loan_information->tenure_in_months"/>
                                    </td>
                                    <td class="font-bold">Take Home Salary:</td>
                                    <td>
                                        <x-input id="take_home_salary" class="block w-full h-8 rounded-none" type="text" name="take_home_salary" :value="$borrower->employment_information->monthly_gross_salary ?? 'N/A'"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-input id="requested_amount_status" class="block w-full h-8 rounded-none" type="text" name="requested_amount_status" :value="$borrower->applicant_requested_loan_information?->status" readonly />
                                    </td>
                                    <td class="font-bold">Amount of Finance / Limit:</td>
                                    <td>
                                        <x-input id="amount_of_finance_limit" class="block w-full h-8 rounded-none" type="text" name="amount_of_finance_limit" :value="$borrower->applicant_requested_loan_information?->requested_amount" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-bold">Previous Outstanding:</td>
                                    <td>
                                        <x-input id="previous_outstanding" class="block w-full h-8 rounded-none" type="text" name="previous_outstanding"/>
                                    </td>
                                    <td class="font-bold">Enhancement Amount:</td>
                                    <td>
                                        <x-input id="enhancement_amount" class="block w-full h-8 rounded-none" type="text" name="enhancement_amount"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-bold">Total Enhancement:</td>
                                    <td>
                                        <x-input id="total_amount" class="block w-full h-8 rounded-none" type="text" name="total_amount"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <x-input id="rate_of_markup" class="block w-full h-8 rounded-none" type="text" name="rate_of_markup"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-bold">Repayment Schedule (Monthly Installment):</td>
                                    <td colspan="3">
                                        Rs. <x-input id="monthly_installment" class="w-1/3 h-8" type="number" min="0" step="0.01" name="monthly_installment"/>
                                        <br>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <x-input id="life_insurance_sgl" class="block w-full h-8 rounded-none" type="text" name="life_insurance_sgl"/>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-input id="borrower_pgs_no_issued" class="block w-full h-8 rounded-none" type="text" name="borrower_pgs_no_issued"/>
                                    </td>
                                    <td class="font-bold">Repayment Status</td>
                                    <td>
                                        <x-input id="borrower_rp_status" class="block w-full h-8 rounded-none" type="text" name="borrower_rp_status"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-bold">Guarantor</td>
                                    <td>
                                        <x-input id="guarantor_pgs_no_issued" class="block w-full h-8 rounded-none" type="text" name="guarantor_pgs_no_issued"/>
                                    </td>
                                    <td class="font-bold">Repayment Status</td>
                                    <td>
                                        <x-input id="guarantor_rp_status" class="block w-full h-8 rounded-none" type="text" name="guarantor_rp_status"/>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
