                                ...
                                @foreach ($references as $reference)
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-1 px-2 text-center">
                                            ...
                                            @if($reference->is_authorize == "No")
                                                @can('authorizer')
                                                    <form action="{{ route('reference.authorized', [$reference->borrower_id, $reference->id]) }}" method="post" class="inline-block" onsubmit="return confirm('Do you really want to authorized this record?');">
                                                        @csrf
                                                        @method('PUT')
