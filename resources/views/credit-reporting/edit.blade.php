                    ...
                    <div class="px-6 mb-4 pt-4 lg:px-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <input class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full"  type="text" value="{{ $creditReporting->name }}" disabled>
                            </div>
                            ...
                            <div>
                                ...
                                <input class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full"  type="text" value="{{ $creditReporting->national_id_cnic }}" disabled>
                            </div>
                        ...
                        <form method="POST" action="{{ route('credit-reporting.update', $creditReporting->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 mt-4">

                                <div>
                                    <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="status">
                                        Status
                                    ...
                                    <select name="status" id="status" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">
                                        ...
                                        <option value="InProcess" {{ old('loan_category_id') == "InProcess" ? 'selected' : '' }}>In Process</option>
                                        <option value="Completed" {{ old('loan_category_id') == "Completed" ? 'selected' : '' }}>Completed</option>
                                    </select>
                                </div>


                                <div>
                                    <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="comments">
                                      Comments
                                        <span class="text-red-700">*</span>
                                    </label>
                                    <input class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" id="comments" type="text" name="comments" value="{{ old('comments') }}" required="required">
                                </div>


                                <div>
                                    <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="path_attachment_one">
                                        Attachment Data Check (PDF, IMG)
                                        <span class="text-red-700">*</span>
                                    </label>
                                    <input class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" id="path_attachment_one" type="file" name="path_attachment_one" value="{{ old('path_attachment_one') }}" required="required">
                                </div>
