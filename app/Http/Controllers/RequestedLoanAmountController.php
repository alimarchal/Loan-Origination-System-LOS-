...
class RequestedLoanAmountController extends Controller
{
     ...
     */
    public function store(StoreRequestedLoanAmountRequest $request)
    {
        //
    }
     ...
     */
    public function edit(RequestedLoanAmount $requestedLoanAmount)
    {
        //
    }
     ...
     */
    public function update(UpdateRequestedLoanAmountRequest $request, RequestedLoanAmount $requestedLoanAmount)
    {
        //
    }
